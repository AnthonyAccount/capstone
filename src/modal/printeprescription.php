<div id="printeprescription" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full h-full">
    <div class="relative ml-16 mr-16 p-4 w-full md:w-1/4 lg:w-1/2 max-w-screen-md">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow-2xl">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
                <h3 class="text-lg font-semibold text-gray-900">PRINT E-PRESCRIPTION</h3>
                <button type="button" class="text-gray-400 bg-transparent hover:bg-green-900 hover:text-white rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="printeprescription">
