...
<body>
    ...
    <div class="p-4 mt-8 bg-white rounded-lg shadow sm:ml-64">
        <h2 class="pb-4 text-lg font-semibold text-gray-500">Pharmacy</h2>
        ...
        <table class="w-full text-sm table-auto">
            <thead class="bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr class="text-sm text-center">
                    <th class="px-4 py-2 text-sm font-bold border-b bg-grey-lightest text-grey-light border-grey-light">Pharmacy Name</th>
                    <th class="px-4 py-2 text-sm font-bold border-b bg-grey-lightest text-grey-light border-grey-light">License</th>
                    <th class="px-4 py-2 text-sm font-bold border-b bg-grey-lightest text-grey-light border-grey-light">Address</th>
                    <th class="px-4 py-2 text-sm font-bold border-b bg-grey-lightest text-grey-light border-grey-light">Contact</th>
                    ...
                    <th class="px-4 py-2 text-sm font-bold border-b bg-grey-lightest text-grey-light border-grey-light">Dispense Activity</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($users as $user) : ?>
                    <tr class="text-center hover:bg-grey-lighter">
                        <td class="flex items-center justify-center px-4 py-2 border-b border-grey-light">
                            <img src="<?php echo $user["image_src"]; ?>" alt="Foto Perfil" class="w-10 h-10 rounded-full">
                        </td>
                        ...
                        <td class="px-4 py-2 text-sm border-b bg-grey-lightest text-grey-light border-grey-light"><?php echo $user["contact_info"]; ?></td>
