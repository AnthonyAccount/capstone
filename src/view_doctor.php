    ...
    <?php if ($canViewUsers): ?>
        ...
        <div class="flex font-sans">
            <div class="flex-none w-48 relative">
                ...
                <img src="data:image/jpeg;base64,<?php echo base64_encode($doctorData['prof_image']); ?>" alt="Doctor's Profile Image" class="absolute inset-0 w-full h-full object-cover" loading="lazy" />
            </div>
